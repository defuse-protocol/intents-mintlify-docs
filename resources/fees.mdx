...
| **Without API key** | Additional **0.1%** fee |

<Tip>
[Apply for an API key](https://partners.near-intents.org/) to avoid the 0.1% unauthenticated fee.
</Tip>

### Distribution Channel Fees

Developers and distribution channels can add their own fees using the [`appFees`](/api-reference/fee-config) parameter when requesting quotes.
