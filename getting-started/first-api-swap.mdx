---
title: "Your First API Swap"
description: "Execute your first intent-based swap using 1Click API"
icon: "arrows-rotate"
---

Let's execute your first cross-chain token swap using intents! For this, we will use the 1Click Swap API, a simple REST API that abstracts away all the complexities of cross-chain swaps. 
