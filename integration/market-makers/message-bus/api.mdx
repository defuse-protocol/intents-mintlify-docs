...
<Warning>
This API is designed for market makers/solvers. Distribution channels should use the [1Click Swap API](/integration/distribution-channels/1click-api/overview) instead.
</Warning>
