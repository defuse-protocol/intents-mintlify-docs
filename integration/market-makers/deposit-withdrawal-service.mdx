...
The Passive Deposit/Withdrawal Service provides an API for moving assets between [supported blockchain networks](/resources/chain-support) and NEAR Intents. Use it to deposit tokens into the protocol and withdraw them to external chains.
