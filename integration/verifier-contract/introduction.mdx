...
Most applications integrating token swaps don't need to work with the Verifier contract directly. The [1Click Swap API](/integration/distribution-channels/1click-api/about-1click-api) handles intent creation, market maker coordination, and execution for you.
...
Before working with directly with the Verifier contract, you should have:
