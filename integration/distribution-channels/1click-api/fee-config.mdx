...
Configure how fees are collected and distributed when using the [1Click Swap API](/integration/distribution-channels/1click-api/overview). As a distribution channel, you can add your own fees on top of the base platform fees.
