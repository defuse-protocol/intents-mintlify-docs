...
<Steps>
  ...
  <Step title="User deposits tokens">
    The user sends tokens to the deposit address. 1Click automatically begins the swap. Optionally use [`/v0/deposit/submit`](/api-reference/endpoint/deposit-submit) with your transaction hash to speed up processing.
  </Step>

  <Step title="Monitor status">
    Poll [`/v0/status`](/api-reference/endpoint/status) to track progress and display updates to your user.
  </Step>
</Steps>
