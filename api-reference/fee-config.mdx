...
Configure how fees are collected and distributed when using the [1Click Swap API](/api-reference/introduction). As a distribution channel, you can specify fee parameters when requesting a quote.
